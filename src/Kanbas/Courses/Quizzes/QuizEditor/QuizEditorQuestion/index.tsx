    ...
    <>
      ...
      >
        <div className="popupbox-container">
          <h5>Do you want to save the quiz?</h5>
      ...
      <div className="d-flex flex-column gap-5">
          ...
          {questions.map((question: any) => (
            <div className="quiz-question-container">
              ...
              <div className="quiz-question-body">
                ...
                <div
                  className="quiz-question-editor-grp 
                        d-flex flex-row gap-4"
                >
                  <Link
                    to={`/Kanbas/courses/${courseId}/Quizzes/${quizId}/editor/${question._id}`}
                  >
                    <button>
                      <FaPencilAlt />
                    </button>
        ...
        <div className="quiz-question-editor-grp d-flex flex-md-row flex-column justify-content-end align-items-md-start align-items-center gap-4 fs-6 ">
          <div
            className="
                        d-flex gap-3
                        "
